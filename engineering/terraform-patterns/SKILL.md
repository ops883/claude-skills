...
> See [references/advanced-patterns.md](references/advanced-patterns.md) for multi-cloud provider configuration, OpenTofu compatibility, Infracost integration, import workflows, Terragrunt patterns, and installation.
