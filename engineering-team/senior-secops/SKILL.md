...
> See [references/security_standards.md](references/security_standards.md) for OWASP Top 10 quick-check, secret scanning tools, and supply chain security patterns.
